...
export const updates = [
  ...
  },
  {
    description: (
      <>
        <p>The battle commenced against Muldur!</p>
        <p>
    ...
    description: (
      <>
        ...
        <p className="mb-0">
          ...
          the level of fitness they desire, despite age, experience, or
          background. Leaving the fellowship with a clear leg up on the demon of
          shame thusfar.
        </p>
      </>
    ),
